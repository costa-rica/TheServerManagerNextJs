...
export default function RegistrarPage() {
	...
	const fetchDomains = useCallback(async () => {
		...
		try {
			const response = await fetch(
				`${connectedMachine.urlFor404Api}/registrar/get-all-porkbun-domains`,
				{
					method: "GET",
					headers: {
	...
	const fetchSubdomains = useCallback(async () => {
		...
		try {
			const response = await fetch(
				`${connectedMachine.urlFor404Api}/registrar/get-all-porkbun-subdomains/${selectedDomain}`,
				{
					method: "GET",
					headers: {
						"Content-Type": "application/json",
	...
	const handleDeleteSubdomainConfirm = async () => {
		...
		try {
			const response = await fetch(
				`${connectedMachine.urlFor404Api}/registrar/porkbun-subdomain`,
				{
					method: "DELETE",
					headers: {
						"Content-Type": "application/json",
	...
	const handleCreateSubdomain = async (e: React.FormEvent) => {
		...
		try {
			const response = await fetch(
				`${connectedMachine.urlFor404Api}/registrar/create-subdomain`,
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
